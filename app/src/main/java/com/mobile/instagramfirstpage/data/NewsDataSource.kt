...
object NewsDataSource {
    fun news(): ArrayList<News> {
        return arrayListOf<News>().apply {
            add(News(1, "1:1","foxnews", "Something happened",1,"https://source.unsplash.com/random/800x800"))
            ...
            add(News(1, "1:1","foxnews", "Something happened",1200,"https://source.unsplash.com/random/800x800"))
